$(document).ready(function(){
    ...
    $('.city-autocomplete').each(function(){
        if($(this).hasClass('city-to-input')) {
            options.onSelect = function(suggestion) {
                $(".city-to").text(suggestion.iata);
                $('.country-to').text(suggestion.country);
            }
        } else {
            options.onSelect = function(suggestion) {
                $(".city-from").text(suggestion.iata);
                $('.country-from').text(suggestion.country);
            }
        }
    ...
    $('.city-autocomplete').on('focus', function(){
        $(this).siblings('.input-container__placeholder').addClass('active');
    });
    
    $('.city-autocomplete').on('blur', function(){
        if($(this).val().trim() == '') {  
            var placeholder =  $(this).siblings('.input-container__placeholder');
